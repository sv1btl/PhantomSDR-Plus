            ...
            >
              ...
              >
                ...
                <span class="text-white text-sm sm:text-sm mr-4 mb-2 sm:mb-0">
                  {siteSysop}:
                  <a href="/cdn-cgi/l/email-protection#84fff7edf0e1d7fdf7ebf4c1e9e5ede8c5e0e0f6e1f7f7f9bbf7f1e6eee1e7f0b9d3e1e6d7c0d6" style="color:rgba(0, 225, 255, 0.993)">email</a>
