...
>
> If you want to be **registered in websdr.org map**, follow these instructions: <br />
> 1.-  Prepare your .toml file, as explained in the topic "The ./toml file": <br />
>
> [websdr.org] <br />
...
> logo        = "logo.jpg" <br />
>
> 2.- Then do the following in terminal:
> ```
...
> ```
> 3.- and finally recompile frontend and backend in terminal:
> ```
> cd PhantomSDR-Plus/
> ./recompile.sh
> ```
...
grid_locator="QTH_LOCATOR" # 4 or 6 length Grid Locatlr shown on https://sdr-list.xyz and for the Distance of FT8 Signals
...
## The Admin area.
This is an optional feature that adds a real-time admin server panel monitoring to your PhantomSDR application using an automated installation script.<br />
Please refer to **[Readme](docs/ADMIN_SETUP.md)** - for detailed instructions.
