...
| `tci-bridge/tci-rigctld.mjs` | Δεν χρησιμοποιείται από τον δέκτη. Ένα μικρό πρόγραμμα Node.js που τρέχει ο ακροατής δίπλα στον δικό του πομποδέκτη: διαβάζει συχνότητα, τρόπο λειτουργίας και κατάσταση εκπομπής από το `rigctld` του Hamlib και τα προσφέρει ως TCI στη θύρα 50001, ώστε το κουμπί **QRG Sync** της σελίδας να ελέγχει πομποδέκτη χωρίς δικό του TCI, όπως το IC-7300 — βλ. [Έλεγχος πομποδέκτη](RIG_CONTROL.md) |
