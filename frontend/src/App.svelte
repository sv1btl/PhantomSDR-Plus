<script>
  const VERSION = "1.6.8 with mobile support and enhancements";
            ...
            >
              ...
              >
                ...
                <span class="text-white text-sm sm:text-sm mr-4 mb-2 sm:mb-0">
                  {siteSysop}:
                  <a href="/cdn-cgi/l/email-protection#19626a706d7c4a606a76695c74787075587d7d6b7c6a6a64266a6c7b737c7a6d244e7c7b4a5d4b" style="color:rgba(0, 225, 255, 0.993)">email</a>
