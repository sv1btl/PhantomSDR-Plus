...
FT2 is even faster variant of FT8. FT2 is an ultra-fast 77-bit mode with TR periods of 3.75 seconds (= 1/2 of FT4) - still experimental.
...
2. Enable the decoder and select **FT4** or **FT2** from the dropdown.
