...
~/PhantomSDR-Plus/rx888_stream/target/release/rx888_stream -f ~/PhantomSDR-Plus/rx888_stream/SDDC_FX3.img -s 60000000 -g 40 -a 0 -m low --pga -d -r -o - > ~/PhantomSDR-Plus/rx888.fifo &
sleep 1
