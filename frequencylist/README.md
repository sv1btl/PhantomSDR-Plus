...
=======
- **NB** Your markers in mymarkers.json will overwrite and replace the duplicate markers from shortwavestations.json in the final markers.json file generated. The given mymarkers.json contains some demo markers, you can replace them with your own!
