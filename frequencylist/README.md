...
- **NB** Your markers in mymarkers.json will overwrite and replace and duplicate marker from shortwavestations.json in the final markers.json file generated shortwavestations.json. The given mymarkers.json contains some demo markers, you can replace them with your own!
