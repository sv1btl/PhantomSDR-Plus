...
export default class SpectrumWaterfall {
  constructor(endpoint, settings) {
    ...
    this.bands = [
	{ ITU: 123,
	    name: 'VLF', min: -60, max: 110, initFreq: '', publishBand: '2', startFreq: 3000, endFreq: 30000,  stepi: 1000, color: 'rgba(199, 12, 193, 0.6)',
	    modes: [{ mode:MODES.CW, startFreq: 3000, endFreq: 30000 }]
	},
	{ ITU: 123,
	    name: 'LF', min: -60, max: 110, initFreq: '77500', publishBand: '2', startFreq: 30000, endFreq: 135000,  stepi: 1000, color: 'rgba(199, 12, 193, 0.6)',
	    modes: [{ mode: MODES.CW, startFreq: 30000, endFreq: 135000 }]
	},
	{ ITU: 123,
	    name: '2200m', min: -50, max: 110, initFreq: '135700', publishBand: '1', startFreq: 135700, endFreq: 137800,  stepi: 100, color: 'rgba(50, 168, 72, 0.6)',
            modes: [{ mode: MODES.CW, startFreq: 135700, endFreq: 137800 }]
	},
	{ ITU: 123,
	    name: '', min: -50, max: 110, initFreq: '', publishBand: '', startFreq: 137800, endFreq: 148500, stepi: 1000, color: '#ffffff00',
	...
	{ ITU: 123,
	    name: '600m', min: -20, max: 110, initFreq: '', publishBand: '1', startFreq: 501000, endFreq: 504000,  stepi: 100, color: 'rgba(50, 168, 72, 0.6)', 
	...
	{ ITU: 3,
        ...
        { ITU: 1,
            name: 'Maritime', min: -40, max: 110, initFreq: '', publishBand: '', startFreq: 4000000, endFreq: 5351500, stepi: 1000, color: '#ffffff00',
            modes: [{ mode: MODES.USB, startFreq: 4000000, endFreq: 5351500 }]
        },
        { ITU: 2,
            name: 'Maritime', min: -40, max: 110, initFreq: '', publishBand: '', startFreq: 4000000, endFreq: 5330500, stepi: 1000, color: '#ffffff00',
  ...
  { ITU: 1,
            name: '60m', min: -40, max: 110, initFreq: '5360000', publishBand: '1', startFreq: 5351500, endFreq: 5366650,  stepi: 1000, color: 'rgba(50, 168, 72, 0.6)',
            modes: [
              { mode: MODES.CW, startFreq: 5351500, endFreq: 5354000 },
              { mode: MODES.USB, startFreq: 5354000, endFreq: 5366500 }]
        },
	{ ITU: 2,
            name: '60m', min: -40, max: 110, initFreq: '', publishBand: '1', startFreq: 5330500, endFreq: 5406500,  stepi: 1000, color: 'rgba(50, 168, 72, 0.6)',
            modes: [{ mode: MODES.USB, startFreq: 5330500, endFreq: 5406500 }]
        },
	{ ITU: 3,
            name: '60m', min: -40, max: 110, initFreq: '', publishBand: '1', startFreq: 5351500, endFreq: 5366650,  stepi: 1000, color: 'rgba(50, 168, 72, 0.6)',
            modes: [
              { mode: MODES.CW, startFreq: 5351500, endFreq: 5354000 },
              { mode: MODES.USB, startFreq: 5354000, endFreq: 5366500 }]
        },
  { ITU: 123,
	          name: 'Aeronautical', min: -40, max: 110, initFreq: '', publishBand: '', startFreq: 5406500, endFreq: 5900000, stepi: 1000, color: '#ffffff00',
            modes: [{ mode: MODES.USB, startFreq: 5406500, endFreq: 5900000 }]
	},
	{ ITU: 123,
            name: '49m AM', min: -40, max: 110, initFreq: '', publishBand: '2', startFreq: 5900000, endFreq: 6200000,  stepi: 5000, color: 'rgba(199, 12, 193, 0.6)', 
            modes: [{ mode: MODES.AM, startFreq: 5900000, endFreq: 6200000 }]
	},
       	{ ITU: 123,
	    name: 'Maritime', min: -40, max: 110, initFreq: '', publishBand: '', startFreq: 6200000, endFreq: 6610000, stepi: 1000, color: '#ffffff00',
	...
	{ ITU: 3,
        ...
        { ITU: 123,
	    name: '', min: -40, max: 110, initFreq: '', publishBand: '', startFreq: 7450000, endFreq: 9400000, stepi: 1000, color: '#ffffff00',
            modes: [{ mode: MODES.USB, startFreq: 7450000, endFreq: 9400000 }]
	},
	{ ITU: 123,
            name: '31m AM', min: -40, max: 110, initFreq: '', publishBand: '2', startFreq: 9400000, endFreq: 9900000,  stepi: 5000, color: 'rgba(199, 12, 193, 0.6)', 
            modes: [{ mode: MODES.AM, startFreq: 9400000, endFreq: 9900000 }]
	},
	{ ITU: 123,
	    name: 'Aeronautical', min: -40, max: 110, initFreq: '', publishBand: '', startFreq: 9900000, endFreq: 10100000, stepi: 1000, color: '#ffffff00',
	...
	{ ITU: 123,
	    name: 'Aeronautical', min: -50, max: 110, initFreq: '', publishBand: '', startFreq: 10150000, endFreq: 11600000, stepi: 1000, color: '#ffffff00',
            modes: [{ mode: MODES.USB, startFreq: 10150000, endFreq: 11600000 }]
	},
	{ ITU: 123,
            name: '25m AM', min: -50, max: 110, initFreq: '', publishBand: '2', startFreq: 11600000, endFreq: 12200000,  stepi: 5000, color: 'rgba(199, 12, 193, 0.6)', 
            modes: [{ mode: MODES.AM, startFreq: 11600000, endFreq: 12200000 }]
	},
	{ ITU: 123,
	    name: 'Marintime', min: -50, max: 110, initFreq: '', publishBand: '', startFreq: 12200000, endFreq: 13570000, stepi: 1000, color: '#ffffff00',
            modes: [{ mode: MODES.USB, startFreq: 12200000, endFreq: 13570000 }]
	},
	{ ITU: 123,
            name: '22m AM', min: -50, max: 110, initFreq: '', publishBand: '2', startFreq: 13570000, endFreq: 13870000,  stepi: 5000, color: 'rgba(199, 12, 193, 0.6)', 
            modes: [{ mode: MODES.AM, startFreq: 13570000, endFreq: 13870000 }]
	},
	{ ITU: 123,
	    name: 'Marintime', min: -50, max: 110, initFreq: '', publishBand: '', startFreq: 13870000, endFreq: 13870000, stepi: 1000, color: '#ffffff00',
            modes: [{ mode: MODES.USB, startFreq: 13870000, endFreq: 13870000 }]
	},
	{ ITU: 123,
            name: '20m', min: -50, max: 110, initFreq: '14280000', publishBand: '1', startFreq: 14000000, endFreq: 14350000,  stepi: 1000, color: 'rgba(50, 168, 72, 0.6)', 
	    modes: [
              { mode: MODES.CW, startFreq: 14000000, endFreq: 14070000 },
              { mode: MODES.USB, startFreq: 14070000, endFreq: 14350000 }]
	},
	{ ITU: 123,
	    name: '', min: -50, max: 110, initFreq: '', publishBand: '', startFreq: 14350000, endFreq: 15100000, stepi: 1000, color: '#ffffff00',
            modes: [{ mode: MODES.USB, startFreq: 14350000, endFreq: 15100000 }]
	},
	{ ITU: 123,
            name: '19m AM', min: -50, max: 110, initFreq: '', publishBand: '2', startFreq: 15100000, endFreq: 15830000,  stepi: 5000, color: 'rgba(199, 12, 193, 0.6)', 
            modes: [{ mode: MODES.AM, startFreq: 15100000, endFreq: 15830000 }]
	},
	{ ITU: 123,
	    name: '', min: -50, max: 110, initFreq: '', publishBand: '', startFreq: 15830000, endFreq: 17480000, stepi: 1000, color: '#ffffff00',
            modes: [{ mode: MODES.USB, startFreq: 15830000, endFreq: 17480000 }]
	},
	{ ITU: 123,
            name: '16m AM', min: -50, max: 110, initFreq: '', publishBand: '2', startFreq: 17480000, endFreq: 17900000,  stepi: 5000, color: 'rgba(199, 12, 193, 0.6)', 
            modes: [{ mode: MODES.AM, startFreq: 17480000, endFreq: 17900000 }]
	},
	{ ITU: 123,
	    name: '', min: -50, max: 110, initFreq: '', publishBand: '', startFreq: 17900000, endFreq: 18068000, stepi: 1000, color: '#ffffff00',
            modes: [{ mode: MODES.USB, startFreq: 17900000, endFreq: 18068000 }]
	},
	{ ITU: 123,
            name: '17m', min: -50, max: 110, initFreq: '18100000', publishBand: '1', startFreq: 18068000, endFreq: 18168000,  stepi: 1000, color: 'rgba(50, 168, 72, 0.6)', 
            modes: [
              { mode: MODES.CW, startFreq: 18068000, endFreq: 18099000 },
              { mode: MODES.USB, startFreq: 18100000, endFreq: 18168000 }]
	},
	{ ITU: 123,
	    name: '', min: -50, max: 110, initFreq: '', publishBand: '', startFreq: 18168000, endFreq: 18900000, stepi: 1000, color: '#ffffff00',
            modes: [{ mode: MODES.USB, startFreq: 18168000, endFreq: 18900000 }]
	},
	{ ITU: 123,
            name: '15m AM', min: -50, max: 110, initFreq: '', publishBand: '2', startFreq: 18900000, endFreq: 19020000,  stepi: 5000, color: 'rgba(199, 12, 193, 0.6)', 
	...
	{ ITU: 123,
            name: '13m AM', min: -60, max: 110, initFreq: '', publishBand: '2', startFreq: 21450000, endFreq: 21850000,  stepi: 5000, color: 'rgba(199, 12, 193, 0.6)', 
            modes: [{ mode: MODES.AM, startFreq: 21450000, endFreq: 21850000 }]
	},
	{ ITU: 123,
	        name: '', min: -60, max: 110, initFreq: '', publishBand: '', startFreq: 21850000, endFreq: 24890000, stepi: 1000, color: '#ffffff00',
            modes: [{ mode: MODES.USB, startFreq: 21850000, endFreq: 24890000 }]
	},
	{ ITU: 123,
            name: '12m', min: -70, max: 110, initFreq: '24915000', publishBand: '1', startFreq: 24890000, endFreq: 24990000,  stepi: 1000, color: 'rgba(50, 168, 72, 0.6)', 
            modes: [
