# PhantomSDR-Plus WebSDR (version 1.6.6)

[![License: GPL v3](https://img.shields.io/badge/License-GPLv3-blue.svg)](https://www.gnu.org/licenses/gpl-3.0)
[![Version](https://img.shields.io/badge/version-1.6.6-green.svg)](https://github.com/sv1btl/PhantomSDR-Plus)
...
./install.sh
```
The script install.sh, will install everything needed so to run the server.
...
- **[User Guide](docs/USER_GUIDE.md)** - Complete guide for using the WebSDR
  ...
  - Digital mode decoders (FT8, RTTY, PSK31)
