...
export class JitterBuffer {
  ...
  add(packet, delay) {
    ...
    // Clamp to [2, 10] — the computed value was previously unconditionally
    // overwritten with 2, making the adaptive logic dead code.
    packetAmount = Math.max(2, Math.min(10, packetAmount));
