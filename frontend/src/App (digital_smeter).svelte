<script>
  const VERSION = "1.6.1 with mobile support and enhancements";
                       ...
                       <div class="flex justify-between items-center mb-2">
                        <span class="font-semibold text-gray-200">Keyboard Shortcuts inside waterfall</span>
                          ...
                          <table class="w-full text-xs">
                            <tbody>
                              <tr>
                                <td class="py-1 text-gray-300">Tune +100 Hz</td>
                                <td class="text-right"><kbd>→</kbd></td>
                              </tr>
                              <tr>
                                <td class="py-1 text-gray-300">Tune –100 Hz</td>
                                <td class="text-right"><kbd>←</kbd></td>
                              ...
                              <tr>
                                <td class="py-1 text-gray-300">Zoom in</td>
                                <td class="text-right"><kbd>Shift + Wheel ↑</kbd></td>
                              </tr>
                              <tr>
                                <td class="py-1 text-gray-300">Zoom out</td>
                                <td class="text-right"><kbd>Shift + Wheel ↓</kbd></td>
                              </tr>
                              <tr>
                                <td class="py-1 text-gray-300">Snap to .00 kHz</td>
                                <td class="text-right"><kbd>Ctrl + Shift + Wheel</kbd></td>
                              </tr>
                            </tbody>
                          </table>
                        </div>
