...
echo "  [3] SDRplay RSP1A        — libmirisdr-5 + SoapyMiri + rx_sdr (open driver)"
echo "  [4] Skip                 — install the SDR driver manually later"
echo "  [5] RigExpert Fobos SDR  — SoapyFobosSDR + rx_sdr (RF and HF direct sampling)"
...
case $option in
    1) TOML="rx888.toml"      ;;
    2) TOML="rtlsdr.toml"     ;;
    3) TOML="config-rsp1a.toml" ;;
    5) TOML="config-fobos-hf.toml" ;;
    6) TOML="config-airspyhf.toml" ;;
    7) TOML="config-hackrf.toml" ;;
    *) TOML="<your_sdr>.toml" ;;
esac
