...
## Examples
Remember to set the frequency and sample rate correctly, in the .sh files, e.g. start-rtl.sh
...
1 is for Africa, Europe, the Middle East, and northern Asia,

2 is for the Americas, including North, Central, and South America, as well as the Caribbean and
...
The image is located in PhantomSDR-Plus/frontend/src/assets/background.jpg
