...
- Decoders, **FT8, FT4, CW, WSPR, HF FAX, SSTV, NAVTEX, FSK/RTTY, FreeDV RADE V1 (please refer here: [Decoders](docs/DECODERS.md) & C-QUAM AM Stereo (best working whem Opus audio_compression is used)**
